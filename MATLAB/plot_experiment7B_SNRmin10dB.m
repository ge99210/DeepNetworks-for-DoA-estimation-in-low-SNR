...
filename = fullfile('C:\Users\geo_p\OneDrive - Heriot-Watt University\HWU2\Code\Python\DoA Estimation',...
        'DoA_Estimation_underdetermined\ComparisonRESULTS\Slide_ang_sep10_K1to3_min10dB_T3000_CNN_RQ.h5');
...
% Visual correction and marking of FP and FN
CNN_pred2(2,110) = CNN_pred2(1,110);
CNN_pred2(1,110) = NaN;
FN_ind1 = gt_ang2(1,110);
...
FN_ind3 = [15, 46, 99];
CNN_pred3(3,FN_ind3(2)) = CNN_pred3(2,FN_ind3(2));
CNN_pred3(2,FN_ind3(2)) = NaN;
CNN_pred3(3,FN_ind3(3)) = CNN_pred3(2,FN_ind3(3));
CNN_pred3(2,FN_ind3(3)) = CNN_pred3(1,FN_ind3(3));
CNN_pred3(1,FN_ind3(3)) = NaN;

figure(1);
plot(sam_ind1, gt_ang1,'Color','#0d47a1');
hold on;
scatter(sam_ind1, CNN_pred1,'Marker','d','MarkerEdgeColor','#9fa8da');
hold off;
xlim([0 sam_ind1(end)+1]); 
ylim([-61 61]);
legend('$\theta_1$', '$\hat{\theta}_1$',  'interpreter','latex','location','northwest')
grid on;
...
scatter(110, FN_ind1,'Marker','+','MarkerEdgeColor','#9c27b0'); % 1 FN error
hold off;
...
scatter(FN_ind3(1), gt_ang3(3,FN_ind3(1)),'Marker','+','MarkerEdgeColor','#9c27b0');
scatter(FN_ind3(2), gt_ang3(2,FN_ind3(2)),'Marker','+','MarkerEdgeColor','#9c27b0');
scatter(FN_ind3(3), gt_ang3(1,FN_ind3(3)),'Marker','+','MarkerEdgeColor','#9c27b0');
hold off;
