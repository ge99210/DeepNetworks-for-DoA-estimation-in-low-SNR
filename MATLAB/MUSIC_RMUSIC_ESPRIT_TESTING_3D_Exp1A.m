...
save(fullfile(save_path,'Slide_angsep4coma7_K2_min10dB_T2000.mat'),'MUSIC_deg','R_MUSIC_deg','ESPRIT_deg','ang_the','ang_sam','ang_the_rm','ang_sam_rm','ang_the_esp','ang_sam_esp','ang_gt');
