...
# New model trained in the lo-SNR regime - 25/09/2020
...
filename1 = 'C:/Users/geo_p/OneDrive - Heriot-Watt University/DoA DATA/DoA_DATA_JOURNALS/TEST_DATA_16ULA_K1_0dBSNR_T1000_3D_fixedang_offgrid.h5'
...
# Load the Test Data for Experiment 1A
filename2 = 'C:/Users/geo_p/OneDrive - Heriot-Watt University/DoA DATA/DoA_DATA_JOURNALS/TEST_DATA_16ULA_K2_0dBSNR_T1000_3D_fixedang_offgrid.h5'
...
# Load the Test Data for Experiment 1A
filename3 = 'C:/Users/geo_p/OneDrive - Heriot-Watt University/DoA DATA/DoA_DATA_JOURNALS/TEST_DATA_16ULA_K3_0dBSNR_T1000_3D_fixedang_offgrid.h5'
...
Table_conf_lev = [prob1, prob2, prob3]
print(Table_conf_lev)
...
plt.ylabel('True K')
plt.show()
f.savefig("Exper6_conf_mat_0dB_RQ.eps", dpi=1200, bbox_inches='tight')
