...
filename1 = 'C:/Users/geo_p/OneDrive - Heriot-Watt University/DoA DATA/DoA_DATA_JOURNALS/TRAIN_DATA_16ULA_K2_low_SNR_res1_3D.h5'
...
cbks = [rlr] #, es, mc] # no early stopping here due to the different stats between trainign and validation data
...
f1.savefig("binary_acc_Adam_lr_def_RoP_0_7.eps", dpi=1200, bbox_inches='tight')
f2.savefig("loss_Adam_lr_def_RoP_0_7.eps", dpi=1200, bbox_inches='tight')
...
f3.savefig("training_perf_Adam_lr_def_RoP_0_7.eps", dpi=1200, bbox_inches='tight')


# In[19]:


model.save('Model_CNN_DoA_class_Data_N16_K2_res1_lowSNR_new_training_RQ_Adam_dropRoP_0_7.h5') 
